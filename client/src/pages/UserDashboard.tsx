          ...
          <table className="min-w-full divide-y divide-slate-200">
            <thead className="bg-slate-50">
              <tr>
                ...
                <th
                  scope="col"
                  className="px-6 py-3 className='text-right' text-xs font-semibold text-slate-500 uppercase tracking-wider"
                >
                  Actions
                </th>
              </tr>
              ...
              {requests.map((req) => (
                <tr key={req._id} className="hover:bg-slate-50/50 transition">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    <span
                      className={`px-2.5 py-1 rounded-full text-xs font-medium ${getPriorityBadgeClass(req.priority)}`}
                    >
                      {req.priority}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    <span
                      className={`px-2.5 py-1 rounded-full text-xs font-medium ${getStatusBadgeClass(req.status)}`}
                    >
                      {req.status}
                    </span>
                  </td>
